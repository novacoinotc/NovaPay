...
export default function RegisterPage() {
  ...
  return (
    <div className="min-h-screen bg-[#050508] flex items-center justify-center py-12 px-4 sm:px-6 lg:px-8 relative overflow-hidden">
      ...
      <div className="orb orb-purple w-[250px] h-[250px] sm:w-[500px] sm:h-[500px] -top-32 -left-32 animate-float-slow" />
      <div className="orb orb-pink hidden sm:block w-[300px] h-[300px] -bottom-16 -right-16 animate-float" />
